<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Bảng điều khiển - Xin chào ') . Auth::user()->name }}
        </h2>
    </x-slot>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-blue-500">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-gray-500 text-sm font-bold">TỔNG THÀNH VIÊN</p>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-green-500">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-gray-500 text-sm font-bold">TỔNG BÀI VIẾT</p>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-yellow-500">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-gray-500 text-sm font-bold">DANH MỤC</p>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex gap-4">
                        <a href="{{ route('posts.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded shadow">
                            + Viết bài mới
                        </a>
                    </div>
                </div>
